...
const sendJobCompletedEmail = async (
  email: string,
  ...
  const mailOptions = {
    ...
    to: email,
    subject: `Your Job "${jobTitle}" is Completed`,
    html: `
    <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto; background-color: #f4f6f8; padding: 20px; border-radius: 12px;">
      ...
      <div style="background-color: #0f766e; padding: 30px 20px; text-align: center; border-radius: 12px 12px 0 0;">
        <h1 style="color: #ffffff; margin: 0; font-size: 26px; font-weight: bold;">✅ Job Completed</h1>
      ...
      <div style="background-color: #ffffff; padding: 30px 25px; border-radius: 0 0 12px 12px; border: 1px solid #e5e7eb;">
        ...
        <p style="color: #4b5563; font-size: 16px; line-height: 1.6; margin-bottom: 25px;">
          Good news! Your job <strong>${jobTitle}</strong> has been successfully completed. You can now review the results in your account.
        </p>

        <p style="color: #4b5563; font-size: 16px; line-height: 1.6; margin-bottom: 25px;">
          For more information or questions regarding this job, please contact the employer directly at 
...
export default sendJobCompletedEmail;
